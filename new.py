...
def home_page():
    st.title("Welcome to the Web Scanning Tool!")
    st.write(
        "This tool allows you to scan a website for various information and vulnerabilities. "
        "Enter the target URL, click 'Scan Website,' and explore the results. You can also download a PDF report."
    )

def main():
    st.sidebar.button("Options", key="options_button")
